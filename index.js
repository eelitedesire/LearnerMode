...
// Rule Schema for Automation Rules
const RuleSchema = new mongoose.Schema({
  name: { type: String, required: true },
  description: String,
  active: { type: Boolean, default: true },
  conditions: [{
    parameter: String,  // "battery_soc", "pv_power", "load", etc.
  ...
  actions: [{
    setting: String,    // "grid_charge", "energy_pattern", etc.
    value: String,      // "Enabled", "Battery first", etc.
    inverter: String    // "inverter_1", "inverter_2", "all"
  }],
...
async function handleMqttMessage(topic, message) {
  ...
  // Handle setting changes - NOW PROPERLY AWAITS THE ASYNC FUNCTIONS
  try {
...
// === Add new handler functions for battery charging settings ===
...
// === Add new handler functions for work mode settings ===
...
// === Notification functions for new setting types ===
...
// Fix 4: Add API endpoints for manually changing work mode settings from UI
